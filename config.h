...
//#define EXTENDED_AUX_STATES
  ...
  /**************************************************************************************/
    ...
    /****************************    PPM Sum Reciver    ***********************************/
      ...
      #define SERIAL_SUM_PPM         ROLL,PITCH,THROTTLE,YAW,AUX2,AUX1,AUX3,AUX4,8,9,10,11 //For some Hitec/Sanwa/Others
 ...
 */
  ...
  /*** FUNCTIONALITY TEMPORARY REMOVED ***/
    ...
    #define AP_MODE 50  // Create a deadspan for GPS.
...
#define LAND_SPEED          120
  ...
  /********************************************************************/
    ...
    #define VBATSCALE       98  // (*) (**) change this value if readed Battery voltage is different than real voltage
    #define VBATNOMINAL     168 // 168 => 100% (4s)
    #define VBATLEVEL_WARN1 151 // 151 => 40%
    #define VBATLEVEL_WARN2 150 // 150 => 30%
    #define VBATLEVEL_CRIT  148 // 148 => 20%
